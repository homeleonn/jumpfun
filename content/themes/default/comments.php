...
<div id="post-comments" class="side-block">
	<div class="block-title"><?=_('comments')?> (<span id="comment-count"><?=$comments['count'] ? $comments['count']:0?></span>)</div>
		...
		<form id="comments-block-form">
			...
			<div id="comments-block">
				...
				<div id="captcha-wrapper" style="margin: 10px 0;">
					...
					<?=_('input captcha')?>: <input type="text" id="captcha-code" name="captcha_code">
				</div>
				<input type="submit" value="<?=_('add comment')?>" class="btn" style="margin-top: 5px;">
			</div>
		</form>
	</div>
</div>
